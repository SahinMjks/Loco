 ...
 */
public class AddBlogsFragment extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_blogs_fragment);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    name = (String) dataSnapshot1.child("name").getValue().toString();
                    dp = (String) dataSnapshot1.child("image").getValue().toString();
                }
            }
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageuri == null) {
                    ...
                    uploadData(titl, description, imageuri);
                }
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (AddBlogsFragment.this.RESULT_OK== resultCode) {
    ...
    private void uploadData(final String titl, final String description,final  Uri uri) {
        ...
        StorageReference postref = FirebaseStorage.getInstance().getReference().child(filepathname);

        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        bitmap.compress(Bitmap.CompressFormat.JPEG, 100, baos);
        byte[] dataBytes = baos.toByteArray();
        UploadTask uploadTask = postref.putBytes(dataBytes);
                    ...
                    databaseReference.child(uid+timestamp).setValue(hashMap)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    imageuri = null;
                                    startActivity(new Intent(context, PostFragment.class));
                                    AddBlogsFragment.this.finish();
                                }
