    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userquery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                // retrieve user data
                //Taking The Particular User who send me the message
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {

                    //Taking his name,online status,image
                    ...
                    //Now if he typing to me then only show typing otherwise nothing
                    ...
                    name.setText(nameh);
                    try {
                        Glide.with(ChatActivity.this).load(image).placeholder(R.drawable.ic_person_1).into(profile);
                    } catch (Exception e) {
